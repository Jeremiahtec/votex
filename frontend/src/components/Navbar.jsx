      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to={user ? '/dashboard' : '/login'} className="flex items-center gap-2.5 group">
            <span className="text-xl font-bold tracking-tight text-white">VoteX</span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              <>
                ...
                <div className="relative ml-1" ref={dropdownRef}>
                  <button
                    ...
                    className="flex items-center gap-2 pl-1 pr-2.5 py-1 rounded-xl border border-zinc-700 bg-zinc-900 hover:bg-zinc-800 hover:border-zinc-600 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500"
                  >
              ...
              <div className="flex items-center gap-2">
                ...
                <Link to="/register" className="text-sm font-semibold bg-white hover:bg-zinc-200 text-zinc-950 px-4 py-2 rounded-xl transition-all duration-200 shadow-btn">
                  Get Started
                </Link>
              </div>
            )}
