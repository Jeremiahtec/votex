...
import { LayoutGrid, AlertCircle, TrendingUp, Archive, Plus, Activity, ArrowRight } from 'lucide-react';
    ...
    <Card hoverable className="flex flex-col h-full animate-fade-in">
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <div className="flex gap-2">
          {isExpired ? (
            <Link to={`/polls/${poll.id}/results`} className="text-sm font-semibold flex items-center text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
              Results <ArrowRight className="w-3.5 h-3.5 ml-1" />
            </Link>
          ) : (
