  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 animate-fade-in">
      ...
      <div className="relative w-full max-w-md bg-zinc-900 border border-zinc-700 rounded-2xl shadow-card p-6 animate-slide-up">
        ...
        {/* Icon + title */}
        <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 ${isDanger ? 'bg-red-500/10 border border-red-500/20' : 'bg-indigo-500/10 border border-indigo-500/20'}`}>
          <span className="text-lg">{isDanger ? '🗑️' : '✔️'}</span>
        </div>
